        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <SpotlightCard className="md:col-span-1 rounded-[32px] p-8 flex flex-col justify-center items-center text-center group" spotlightColor="rgba(59, 130, 246, 0.4)">
                 <div className="w-20 h-20 bg-blue-500/10 rounded-full flex items-center justify-center text-blue-500 mb-6 group-hover:rotate-12 transition-transform duration-300 shadow-inner shadow-blue-500/20"><Smartphone size={36} /></div>
                 <h3 className="text-2xl font-bold mb-2 group-hover:text-blue-500 transition-colors">Mobil Uygulama</h3>
                 <p className="text-neutral-500 dark:text-neutral-400">Flutter & React Native ile iOS/Android.</p>
            </SpotlightCard>
            <SpotlightCard className="md:col-span-1 rounded-[32px] p-8 flex flex-col justify-center items-center text-center group" spotlightColor="rgba(168, 85, 247, 0.4)">
                 <div className="w-20 h-20 bg-purple-500/10 rounded-full flex items-center justify-center text-purple-500 mb-6 group-hover:scale-110 transition-transform shadow-inner shadow-purple-500/20"><Database size={36} /></div>
                 <h3 className="text-2xl font-bold mb-2 group-hover:text-purple-500 transition-colors">Backend & API</h3>
                 <p className="text-neutral-500 dark:text-neutral-400">Node.js, SQL/NoSQL mimarileri.</p>
            </SpotlightCard>
            <SpotlightCard className="md:col-span-2 rounded-[32px] p-10 flex flex-col justify-between group" spotlightColor="rgba(236, 72, 153, 0.4)">
                <div className="flex justify-between items-start">
                    <div className="w-16 h-16 bg-pink-500/10 rounded-2xl flex items-center justify-center text-pink-500 mb-4 group-hover:rotate-[-10deg] transition-transform duration-500 shadow-inner shadow-pink-500/20"><Layers size={32} /></div>
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400 text-lg">Figma'dan koda kusursuz geçiş. Kullanıcı odaklı arayüzler.</p>
                </div>
            </SpotlightCard>
          </motion.div>
        </div>
            ...
            {projects.map((project, index) => (
                <motion.div key={project.id} initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8 }} className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center group">
                  <div className={`md:col-span-5 ${index % 2 !== 0 && 'md:order-2'}`}>
                    ...
                    <Link href={`/projects/${project.id}`} className="inline-flex items-center gap-3 text-lg font-bold border-b-2 border-black dark:border-white pb-1 hover:border-cyan-500 hover:text-cyan-500 transition-all">
